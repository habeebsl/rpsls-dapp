...
import { addNotification, getNotifications, getUnreadNotificationCount } from '@/lib/redis';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!notification.id || !notification.type || !notification.message || !notification.from || !notification.to) {
      return NextResponse.json(
